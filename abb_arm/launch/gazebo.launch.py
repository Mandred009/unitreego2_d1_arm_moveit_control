...
def generate_launch_description():
    ...
    xacro_file = os.path.join(abb1200_description_path,
                              'description','urdf','d1_description.urdf.xacro')
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            "abb_arm", package_name="d1_arm_moveit_config"
        )
    ...
    robot_description_config = xacro.process_file(
        os.path.join(
            get_package_share_directory("abb_arm"),'description','urdf','d1_description.urdf.xacro',
        )
    )
    ...
    kinematics_yaml = load_yaml(
        "d1_arm_moveit_config", "config/kinematics.yaml"
    )
    robot_description_kinematics = {"robot_description_kinematics": kinematics_yaml}

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "d1_arm_moveit_config", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("d1_arm_moveit_config"), "config")
